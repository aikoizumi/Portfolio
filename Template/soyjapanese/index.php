...
<title>Soy Japanese Bondi</title>   
...
<header>
    <div class="sticky-nav">
        ...
        <div id="logo">
        	<a id="goUp" href="#home-slider" title="Brushed | Responsive One Page Template">SOY JAPANESE</a>
        </div>
        	...
        	<div class="span3">
                ...
                <nav id="options" class="work-nav">
                    <ul id="filters" class="option-set" data-option-key="filter">
                    	<li class="type-work">Photo</li>
                        <li><a href="#filter" data-option-value="*" class="selected">All</a></li>
                        <li><a href="#filter" data-option-value=".view">View</a></li>
                        <li><a href="#filter" data-option-value=".starter">Starter</a></li>
                        <li><a href="#filter" data-option-value=".main">Main</a></li>
                    </ul>
                </nav>
                <!-- End Filter -->
            </div>
    ...
    <div class="row">
    	...
    	<div class="span4 profile">
        	<div class="image-wrap">
                <div class="hover-wrap">
                    <span class="overlay-img"></span>
                    <span class="overlay-text-thumb">Ryuta Aiba</span>
                </div>
...
<div class="container">
    ...
    <div class="row">
        <div class="span12">
            <div class="title-page">
                <h2 class="title">Location & Opening Hour</h2>
                <h3 class="title-description"></h3>
            </div>
        </div>
    </div>
    ...
    <div class="row">
    	<div class="span7">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3311.860376660746!2d151.2706233152109!3d-33.89324958064949!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6b12ad9b12b32001%3A0x4741decb0863b7b7!2sSOY+Japanese+Restaurant!5e0!3m2!1sja!2sph!4v1541752923808" width="500" height="300" frameborder="0" style="border:0" allowfullscreen></iframe>
        ...
        <div class="span5">
        	<div class="contact-details">
                ...
                <ul>
                    ...
                    <li>Thursday to Sunday from 12:00pm till late</li>
                    <li><a>Dinner</a><li>
                        <li>Monday to Sunday from 18:00pm till late</li>
                        <li>Thursday to Sunday from 17:30pm till late</li>
                        <br>
                </ul>
            </div>
        </div>
